...
public class FirebaseProjectConfigurations : MonoBehaviour
{
    ...
    public static string FIREBASE_GAME_NAME = "battleofminds";
    ...
    private const string project_api_key_release = "";
    private const string project_api_key_debug = "";
    private const string project_api_key_emulator = "project_api_key";

    private const string project_id_release = "";
    private const string project_id_debug = "";
    private const string project_id_emulator = "dzgamesdebugproject";

    private static string realtime_database_root_path_release = "/" + FIREBASE_GAME_NAME;
    private static string realtime_database_root_path_debug = "/" + FIREBASE_GAME_NAME;
    ...
    private static string platform_database_root_path_debug = "/";
